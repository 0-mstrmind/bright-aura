...
## Hosted Prototype URL: https://brightaura.electrolabs.org/
...
- Dashboard to manage/monitor streetlight status in real-time
- Auto location fetch & location search, auto data fetching from system for fast updates in real-time
...
- It is mandatory to create ".env.local" file and give correct values to environment variables to make the app work in development, Please check ".env.example" file for reference.
